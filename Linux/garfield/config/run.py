...
from garfield.config.write_output import print_debug, StandardOutput
from garfield.config.constant import constant
from garfield.config.manage_modules import get_categories, get_modules
...
def run_garfield(category_selected='all', subcategories={}):
    """
    Main function
    """
    if not constant.st:
